...
from .app_settings.models import SubscriptionType, Room
from .app_settings.service import user_action
from .common_servicies.service import OPERATION_TYPES, get_date_range
from .finance.models import Finance
from .finance.service import finance_operation
from .common_servicies.excel_generators import download_timetable
from .models import Person, Employee, Lesson, Subscription, SubjectType, Subject, SchoolClass, \
    SchoolLessonJournal
from .forms import ChildForm, AdultForm, EditStudentForm, EditContactPersonForm, ContactForm, \
...
from .app_functions import DAYS_OF_WEEK, MONTHS, get_today_date, basic_student_info, subscription_subjects_data, \
    ...
    handle_after_school_adding, get_period, del_record, add_new_event, get_date, subject_record, check_subscriptions, \
    calc_day_index
...
def school_subject(subject_classes, month_index):
    if current_user.rights in ["admin", "user", "teacher"]:
        ...
        return render_template('school_subject.html', subject_records=subject_records, dates_topics=dates_topics,
                               ...
                               subject_classes=subject_classes, grade_types=grade_types, finals=finals, month=month)
...
def student_school_record(student_id, month_index):
    ...
    if school_student and month_index is not None:
        ...
        return render_template('school_student.html', student=school_student, dates_topics=dates_topics,
                               ...
                               finals=finals, month_index=month_index, month=month)
